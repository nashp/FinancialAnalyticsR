...
p <- c(3.0,3.0,2.0,11.88,5.9,1.95,3.90,3.90,
       1.5,.75,1.00,1.2,1.4,1.8,2.1,1.05,1.30,1.31,1.32,.44,
       .43,.11,.12,.13)
...
library(tseries)
pv <- get.hist.quote('YHOO',quote="Adj",start="2011-02-09",
                     end="2015-02-09")
pv
...
#unit test: 
getHistPrices(c('PCLN','UA'),c(.5,.5),252)
